...
public void OnPluginStart() {
	...
	ItemDefine("Croc-o-Style Kit", "crocostyle", "Restored release item set bonus, no death from headshots when above 1 HP. Equip the Sydney Sleeper, DDS and Bushwacka to gain the bonus, Ol' Snaggletooth not required", CLASSFLAG_SNIPER);
#if defined VERDIUS_PATCHES
	...
	ItemDefine("Hibernating Bear", "hibernate", "Restored release item set bonus, +5% crit resist. Equip the Brass Beast, Buffalo Steak Sandvich and Warrior's Spirit to gain the bonus, Big Chief not required", CLASSFLAG_HEAVY);
