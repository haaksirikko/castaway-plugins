...
#define ITEMFLAG_PICKOVERRIDE (1 << 11) // If this variant is enabled, it will override every instance of this revert
#define ITEMFLAG_MEMPATCH (1 << 12) // Requires a memory patch
